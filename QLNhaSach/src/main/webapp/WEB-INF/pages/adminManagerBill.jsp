...
<body>
	...
	<div id="wrapper">
		...
		<div id="rightContent">
			...
			<a class="btn btn-success" href="adminManagerPaidBill?indexPage=1">Chuyển qua hóa đơn Đã thanh toán</a>
			...
			<table class="data">
				<tr class="data">
					...
					<th class="data" width="30px">Email</th>
					...
					<th class="data">Lưu</th>
					<th class="data">Xóa</th>
				</tr>
				<c:forEach items="${listBill}" var="bi">
					<tr class="data">
						...
						<td class="data"><a href="adminSaveBill?billId=${bi.billId}"><i class="fa fa-floppy-o"></i></a>
						</td>
						<td class="data"><a href="adminDeleteBill?billId=${bi.billId}"><i class="fa fa-trash"></i></a></td>
					</tr>
				</c:forEach>
			</table>
			<ul class="pagination">
				<c:forEach items="${listPages}" var="pa">
					...
					<c:if test="${pa != indexPage}">
						<li><a href="adminManagerBill?indexPage=${pa}">${pa}</a></li>
					</c:if>
				</c:forEach>
			</ul>
			<div class="clear"></div>
